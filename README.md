...
[![Firmwares](https://img.shields.io/badge/firmware%20profiles-36-success?style=for-the-badge)](#-supported-firmware)
...
36 firmware profiles ship in `src/config/profiles/` — each tracks its **latest upstream release** at flash time and auto-selects the correct per-board binary.
...
| **MCLite** (MeshCore) | Off-grid mesh comms | ESP32-S3 (T-Deck Plus / T-Watch Ultra) | esptool (merged) |
