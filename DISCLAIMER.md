...
## High-risk features
This app can drive firmware that transmits RF and runs deauth/attack flows. Operating an RF **jammer** is illegal in most jurisdictions (47 U.S.C. §333 + worldwide equivalents); the app's role for a jammer is **flash / read / STOP-and-contain only**, for use inside an **authorized RF-shielded enclosure** on hardware you own. Deauth, evil-portal, and beacon/BLE-spam flows are illegal against networks you don't own or aren't authorized to test.
