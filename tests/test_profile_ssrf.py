...
def test_bundled_profiles_all_pass_url_validation():
    ...
    # 27 = 18 original + trex/mclite/bit_pirate + hydra32 + flipper_roguemaster + m5stick_nemo +
    # esp8266_deauther + m5gotchi/porkchop (all drop-in JSON, github.com/api.github.com hosts).
    assert len(flash_core.PROFILES) == 27
