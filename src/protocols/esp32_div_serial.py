...
class Esp32DivSerialProtocol(BaseProtocol):
    ...
    def get_commands(self) -> list[CommandInfo]:
        return [
            ...
            CommandInfo("deauth", "Offensive", "Deauth the selected target", danger="lab-only"),
            CommandInfo("deauth all", "Offensive", "Deauth all discovered APs", danger="lab-only"),
            CommandInfo("beacon", "Offensive", "Beacon spam (random SSIDs)", danger="lab-only"),
            CommandInfo("beacon list", "Offensive", "Beacon spam from an SSID list", danger="lab-only"),
            ...
            CommandInfo("blespam", "Offensive", "BLE notification spam (all)", danger="lab-only"),
            CommandInfo("blespam apple", "Offensive", "BLE spam (Apple popups)", danger="lab-only"),
            CommandInfo("blespam samsung", "Offensive", "BLE spam (Samsung)", danger="lab-only"),
            ...
            CommandInfo("nrf jam", "Offensive", "NRF24 channel jamming (fork: inert stub — jam-fire is owner/Mythos-completed)", danger="illegal-tx"),
            # ── Target select (safe) ──────────────────────────────────
